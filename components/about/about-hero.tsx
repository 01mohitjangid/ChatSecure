...
export const AboutHero = () => {
  return (
    <section className="relative w-full bg-zinc-100 text-black overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.045)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.045)_1px,transparent_1px)] bg-[size:72px_72px] opacity-15" />

      <div className="absolute -top-20 -left-20 w-80 h-80 bg-white/70 rounded-full blur-[1px]" />
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-500/10 rounded-full blur-[2px]" />
